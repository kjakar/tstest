...
var symbolicNames = [ null, "WHITESPACE", "COMMENT", "SEMI", "WHILE", "LP", 
                      ...
                      "FPNUM", "OR", "AND", "NOT", "RELOP", "EQ", "PLUS", 
                      "MULOP", "MINUS", "CMA", "TYPE", "STRINGCONSTANT", 
                      "PRINT", "INPUT", "OPEN", "READ", "WRITE", "CLOSE", 
                      "ID" ];

var ruleNames =  [ "start", "stmts", "stmt", "loop", "cond", "braceblock", 
...
StartContext.prototype.varDeclList = function() {
    return this.getTypedRuleContext(VarDeclListContext,0);
};

StartContext.prototype.braceblock = function() {
